    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            linq.SeedData();
               ...
               var productsBetween20000And40000 = linq.GetProduct().Where(p => p.Price >= 20000 && p.Price <= 40000)
               ...
               var productsWithLetterA = linq.GetProduct().Where(p => p.ProductName.Contains("a"));
               ...
               var productsInAlphabeticalOrder = linq.GetProduct().OrderBy(p => p.ProductName);
               ...
               var highestPrice = linq.GetProduct().Max(p => p.Price);
               
               Console.WriteLine("\nHighest Price from Product List: " + highestPrice);
               
               bool productWithIdP003Exists = linq.GetProduct().Any(p => p.ProductID == "P003");
